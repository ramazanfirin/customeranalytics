...
public class FTPServer implements Closeable {
     ...
     */
    public FTPServer(IUserAuthenticator auth,FaceRecognitionService faceRecognitionService) {
    ...
    protected FTPConnection createConnection(Socket socket) throws IOException {
        return new FTPConnection(this, socket, idleTimeout, bufferSize,faceRecognitionService);
    }
